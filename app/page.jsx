...
const GITHUB_USERNAME = 'VeryardDev'
    ...
    <main>
      ...
      <section id="contact" className="section-card shell">
        ...
        <div className="contact-grid">
          <a className="contact-card whatsapp" href="https://wa.me/" target="_blank" rel="noreferrer">
          ...
          <a className="contact-card instagram" href="https://instagram.com/arda888_" target="_blank" rel="noreferrer">
            <span className="brand-contact-icon instagram-icon"><Instagram /></span>
            <div><strong>Instagram</strong><span>Follow untuk update terbaru</span><b>@arda888_</b></div>
            <ArrowUpRight />
          </a>
